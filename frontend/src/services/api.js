...
export const getWeights = (catId) => request(`/cats/${catId}/weightentries`);
export const addWeight = ({ catId, ...weightData }) => jsonRequest(`/cats/${catId}/weightentries`, { method: 'POST', body: weightData });
