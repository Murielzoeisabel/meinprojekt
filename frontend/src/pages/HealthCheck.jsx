  ...
  return (
    <AnimatedPage>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '800px', marginBottom: '3rem' }}>
        <motion.div className="card" whileHover={{ y: -6, x: 2, scale: 1.01 }} transition={{ duration: 0.2 }} style={{ borderLeft: '4px solid var(--accent-primary)' }}>
        ...
        <motion.div className="card" whileHover={{ y: -6, x: 2, scale: 1.01 }} transition={{ duration: 0.2 }} style={{ borderLeft: '4px solid #f59e0b' }}>
        ...
        <motion.div className="card" whileHover={{ y: -6, x: 2, scale: 1.01 }} transition={{ duration: 0.2 }} style={{ borderLeft: '4px solid var(--danger)' }}>
